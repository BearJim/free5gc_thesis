...
import (
	...
	"github.com/free5gc/amf1/communication"
	"github.com/free5gc/amf1/consumer"
	"github.com/free5gc/amf1/context"
	"github.com/free5gc/amf1/eventexposure"
	"github.com/free5gc/amf1/factory"
	"github.com/free5gc/amf1/httpcallback"
	"github.com/free5gc/amf1/location"
	"github.com/free5gc/amf1/logger"
	"github.com/free5gc/amf1/mt"
	"github.com/free5gc/amf1/ngap"
	ngap_message "github.com/free5gc/amf1/ngap/message"
	ngap_service "github.com/free5gc/amf1/ngap/service"
	"github.com/free5gc/amf1/oam"
	"github.com/free5gc/amf1/producer/callback"
	"github.com/free5gc/amf1/util"
...
func (amf *AMF) Initialize(c *cli.Context) error {
	...
	if config.amfcfg != "" {
		...
		DefaultAmfConfigPath := path_util.Free5gcPath("free5gc/config/amfcfg_1.yaml")
...
func (amf *AMF) Start() {
	initLog.Infoln("AMF1 Server started")
