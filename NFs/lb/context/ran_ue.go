...
type RanUe struct {
	...
	/* context used for LB Re-allocation procedure */
	OldLbName             string
...
func (ranUe *RanUe) Remove() error {
	...
	if ranUe.LbUe != nil {
		ranUe.LbUe.DetachRanUe(ran.AnType)
		ranUe.DetachLbUe()
	}
	...
	self := LB_Self()
	self.RanUePool.Delete(ranUe.LbUeNgapId)
	lbUeNGAPIDGenerator.FreeID(ranUe.LbUeNgapId)
	return nil
}

func (ranUe *RanUe) DetachLbUe() {
	ranUe.LbUe = nil
}

func (ranUe *RanUe) SwitchToRan(newRan *LbRan, ranUeNgapId int64) error {
	if ranUe == nil {
...
func (ranUe *RanUe) UpdateLocation(userLocationInformation *ngapType.UserLocationInformation) {
	...
	case ngapType.UserLocationInformationPresentUserLocationInformationEUTRA:
		...
		if ranUe.LbUe != nil {
			if ranUe.LbUe.Tai != ranUe.Tai {
				ranUe.LbUe.LocationChanged = true
			}
			ranUe.LbUe.Location = deepcopy.Copy(ranUe.Location).(models.UserLocation)
			ranUe.LbUe.Tai = deepcopy.Copy(*ranUe.LbUe.Location.EutraLocation.Tai).(models.Tai)
		}
	case ngapType.UserLocationInformationPresentUserLocationInformationNR:
		...
		if ranUe.LbUe != nil {
			...
			ranUe.LbUe.Location = deepcopy.Copy(ranUe.Location).(models.UserLocation)
			ranUe.LbUe.Tai = deepcopy.Copy(*ranUe.LbUe.Location.NrLocation.Tai).(models.Tai)
		}
	case ngapType.UserLocationInformationPresentUserLocationInformationN3IWF:
		...
		ranUe.Location.N3gaLocation.N3gppTai = &models.Tai{
			PlmnId: lbSelf.SupportTaiLists[0].PlmnId,
			Tac:    lbSelf.SupportTaiLists[0].Tac,
		}
		ranUe.Tai = deepcopy.Copy(*ranUe.Location.N3gaLocation.N3gppTai).(models.Tai)

		if ranUe.LbUe != nil {
			ranUe.LbUe.Location = deepcopy.Copy(ranUe.Location).(models.UserLocation)
			ranUe.LbUe.Tai = *ranUe.Location.N3gaLocation.N3gppTai
		}
