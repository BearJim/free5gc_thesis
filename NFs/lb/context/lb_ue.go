...
type LbUe struct {
	/* the LB which serving this LbUe now */
	servingLB *LBContext // never nil
	...
	/* Used for LB relocation */
	TargetLbProfile *models.NfProfile
	TargetLbUri     string
	/* Ue Identity*/
	...
	EBI                 int32
	/* Ue Identity*/
	EventSubscriptionsInfo map[string]*LbUeEventSubscription
	/* User Location*/
...
type LbUeEventSubscription struct {
	Timestamp         time.Time
	AnyUe             bool
	RemainReports     *int32
...
func (ue *LbUe) init() {
	...
	ue.EventSubscriptionsInfo = make(map[string]*LbUeEventSubscription)
...
func (ue *LbUe) ServingLB() *LBContext {
	return ue.servingLB
}

func (ue *LbUe) CmConnect(anType models.AccessType) bool {
...
func (ue *LbUe) CmIdle(anType models.AccessType) bool {
...
func (ue *LbUe) Remove() {
	...
	if len(ue.Supi) > 0 {
		LB_Self().UePool.Delete(ue.Supi)
	}
}

func (ue *LbUe) DetachRanUe(anType models.AccessType) {
	delete(ue.RanUe, anType)
}

func (ue *LbUe) AttachRanUe(ranUe *RanUe) {
	...
	ranUe.LbUe = ue
	ue.NASLog = logger.NasLog.WithField(logger.FieldLbUeNgapID, fmt.Sprintf("LB_UE_NGAP_ID:%d", ranUe.LbUeNgapId))
	ue.GmmLog = logger.GmmLog.WithField(logger.FieldLbUeNgapID, fmt.Sprintf("LB_UE_NGAP_ID:%d", ranUe.LbUeNgapId))
}

func (ue *LbUe) GetAnType() models.AccessType {
...
func (ue *LbUe) GetCmInfo() (cmInfos []models.CmInfo) {
...
func (ue *LbUe) InAllowedNssai(targetSNssai models.Snssai, anType models.AccessType) bool {
...
func (ue *LbUe) InSubscribedNssai(targetSNssai models.Snssai) bool {
...
func (ue *LbUe) GetNsiInformationFromSnssai(anType models.AccessType, snssai models.Snssai) *models.NsiInformation {
	for _, allowedSnssai := range ue.AllowedNssai[anType] {
...
func (ue *LbUe) TaiListInRegistrationArea(taiList []models.Tai, accessType models.AccessType) bool {
...
func (ue *LbUe) HasWildCardSubscribedDNN() bool {
...
func (ue *LbUe) SecurityContextIsValid() bool {
...
func (ue *LbUe) DerivateNH(syncInput []byte) {
	P0 := syncInput
	L0 := UeauCommon.KDFLen(P0)
...
func (ue *LbUe) UpdateSecurityContext(anType models.AccessType) {
...
func (ue *LbUe) ClearRegistrationRequestData(accessType models.AccessType) {
...
func (ue *LbUe) SetOnGoing(anType models.AccessType, onGoing *OnGoing) {
...
func (ue *LbUe) OnGoing(anType models.AccessType) OnGoing {
	return *ue.onGoing[anType]
}

func (ue *LbUe) RemoveAmPolicyAssociation() {
...
func (ue *LbUe) StoreSmContext(pduSessionID int32, smContext *SmContext) {
	ue.SmContextList.Store(pduSessionID, smContext)
}

func (ue *LbUe) SmContextFindByPDUSessionID(pduSessionID int32) (*SmContext, bool) {
