...
import (
	...
	"github.com/free5gc/amf2/communication"
	"github.com/free5gc/amf2/consumer"
	"github.com/free5gc/amf2/context"
	"github.com/free5gc/amf2/eventexposure"
	"github.com/free5gc/amf2/factory"
	"github.com/free5gc/amf2/httpcallback"
	"github.com/free5gc/amf2/location"
	"github.com/free5gc/amf2/logger"
	"github.com/free5gc/amf2/mt"
	"github.com/free5gc/amf2/ngap"
	ngap_message "github.com/free5gc/amf2/ngap/message"
	ngap_service "github.com/free5gc/amf2/ngap/service"
	"github.com/free5gc/amf2/oam"
	"github.com/free5gc/amf2/producer/callback"
...
func (amf *AMF) Initialize(c *cli.Context) error {
	...
	if config.amfcfg != "" {
		...
		DefaultAmfConfigPath := path_util.Free5gcPath("free5gc/config/amfcfg_2.yaml")
